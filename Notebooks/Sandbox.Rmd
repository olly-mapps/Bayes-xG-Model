...
#Runs stan
bmod3 <- stan(file = "../Stan Files/dist+shortName.stan", data = bmod3_list, chains = 4, init = 0, seed = 1)
```
...
We next visualise a prediction of the model, to emphasies how this new models now considers player abilities.

```{r}
#Extracts generated quantities
ext_fit_4 <- extract(bmod3)
